...
const defaultFavicon = "/alfe_favicon.ico";
const rotatingFavicon = "/alfe_favicon.ico";
let favElement = null;
...
function formatBranchDisplayName(branchName) {
...
async function updateProjectInfo() {
  try {
    ...
    if(infoEl){
      if(projectName){
        const branchDisplay = formatBranchDisplayName(branch);
        infoEl.textContent = branchDisplay
            ? `Project: ${projectName} (branch: ${branchDisplay})`
