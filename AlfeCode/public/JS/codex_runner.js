(() => {
  ...
  'Create a simple blog with markdown support.',
  'Implement server-side pagination for a list.',
  'Add drag-and-drop file upload UI.',
  'Build a real-time collaborative editor.',
  'Create a currency converter using live rates.',
  'Implement image upload and resizing.',
  'Create a Kanban board for tasks.',
  'Build a URL shortener service.',
  'Create a quiz app with scoring.',
  'Implement dark mode toggle across the app.',
  'Build a photo gallery with lazy loading.',
  'Create a searchable FAQ component.',
  'Implement role-based access control.',
  'Build a chat bot that replies to keywords.',
  'Create an interactive map with markers.',
  'Implement form validation with accessible errors.',
  'Build a notes app with localStorage sync.',
  'Create a CSS grid layout demo.',
  'Implement WebSocket-based notifications.',
  'Build a resume parser to extract skills.',
  'Create a Markdown to PDF exporter.',
  'Implement social sharing for posts.',
  'Build a product comparison table UI.',
  'Create a contact form with email delivery.',
  'Implement image lazy-loading with placeholders.',
  'Build a music player with playlist support.',
  'Create a fitness tracker dashboard.',
  'Implement a checkout flow with cart persistence.',
  'Build a small e-commerce product listing.',
  'Create a reusable modal component.',
  'Implement keyboard shortcuts across the app.',
  'Build a CSV importer and previewer.',
  'Create an expense tracker with charts.',
  'Implement a feature flag system.',
  'Build a tag-based search for content.',
  'Create a language translation switcher.',
  'Implement unit+integration tests for API.',
  'Build a browser extension popup UI.',
  'Create a simple recommendation engine.',
  'Implement optimistic UI updates.',
  'Build a component library storybook demo.',
  'Create a server health dashboard.',
  'Implement rate-limiting middleware.',
  'Build a labeled dataset uploader for ML.',
  'Create a graph visualization for relationships.',
  'Implement file versioning and diff viewer.',
  'Build a search autocomplete with remote suggestions.',
  'Create a newsletter signup flow with double opt-in.',
  'Implement SSO integration with SAML.',
  'Build a captcha-protected signup form.',
  'Create a birthday reminder app with notifications.',
  'Implement multi-language i18n support.',
  'Build a stock price tracker with charts.',
  'Create a code snippet manager with syntax highlight.',
  'Implement an RSS feed reader.',
  'Build a markdown-based wiki system.',
  'Create an AI prompt playground for testing prompts.',
  'Implement background job processing with retries.',
  'Build a backup scheduler and monitor UI.',
  'Create a quiz generator from a text corpus.',
  'Implement an interactive tutorial overlay.',
  'Build a dynamic form builder UI.',
  'Create a habit tracker with streaks.',
  'Implement push notifications for web.',
  'Build a dataset visualizer for CSVs.',
  'Create a link-in-bio page builder.',
  'Implement schema migrations for a DB.',
  'Build a time-tracking app with reports.',
  'Create a health-check endpoint for services.',
  'Implement a webhook receiver with retries.',
  'Build a sitemap generator for a website.',
  'Create a CLI-based project scaffolder.',
