(() => {
  ...
  'Make a simple product catalog.',
  'Build a searchable list.',
  'Create a tag input component.',
  'Make a CSV viewer.',
  'Build a simple map marker app.',
  ...
  'Create a simple chat-bot mock UI.',
  'Make a movie search UI.',
  'Build a simple podcast player.',
  'Create a README badge generator.',
  'Make a gradient background picker.',
  'Build a simple calendar view.',
  ...
  'Make a simple contact list with search.',
  ...
  'Make a simple hero section template.',
];
