...
Standardized Debian deployment (from scratch, with app code in `/git/alfe-ai`, user repos in `/git/sterling`, Qwen CLI, and optional local git host demo setup): `deploy/debian/README.md`
