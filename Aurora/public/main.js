...
const DEFAULT_CODE_REDIRECT_TARGET = window.AURORA_FLAGS?.codeRedirectTarget || 'https://internal-chat.alfe.bot';
...
async function handleCodeNavClick(fromIcon = false){
  try {
    ...
    const target = window.AURORA_FLAGS?.codeRedirectTarget || 'https://internal-chat.alfe.bot';
